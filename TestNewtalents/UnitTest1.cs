...
namespace TestNewtalents
{
    ...
    {   public Calculadora construirClasse()
        ...
        [InlineData(6, 2, 3)]
        [InlineData(5, 5, 1)]
        public void TestmutiDividir(int val1, int val2, int resultado)
        {
            Calculadora calc = construirClasse();
        ...
        [InlineData(6, 2, 4)]
        [InlineData(5, 5, 0)]
        public void TestmutiSubtrair(int val1, int val2, int resultado)
        {
            Calculadora calc = construirClasse();
